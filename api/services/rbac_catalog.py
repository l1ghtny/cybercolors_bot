...
PERMISSIONS: tuple[PermissionDefinition, ...] = (
    ...
    PermissionDefinition(
        ...
        "read",
        "View member history",
        "View private member notes and the unified moderation timeline.",
        "read_only",
    ),
    ...
    PermissionDefinition(
        ...
        "moderation",
        "Edit action commentary",
        "Edit private moderator commentary without changing the member-facing reason.",
        "change",
    ),
    PermissionDefinition(
        "moderation.member_notes.manage",
        "moderation",
        "Manage member notes",
        "Add and remove private notes from a member's shared moderation history.",
        "change",
    ),
