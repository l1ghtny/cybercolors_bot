...
from api.routers.server_overview_settings import server_overview_settings_router
...
server_settings.include_router(server_overview_settings_router, tags=["servers:overview-settings"])
