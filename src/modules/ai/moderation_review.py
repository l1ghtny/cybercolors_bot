...
async def create_ai_moderation_decision(
    *,
    ...
    decision = AIModerationDecision(
        ...
        response_id=raw_response.id if raw_response else None,
        total_tokens=raw_response.total_tokens if raw_response else 0,
        input_tokens=raw_response.input_tokens if raw_response else 0,
        cached_input_tokens=raw_response.cached_input_tokens if raw_response else 0,
        output_tokens=raw_response.output_tokens if raw_response else 0,
        reasoning_tokens=raw_response.reasoning_tokens if raw_response else 0,
