...
class ServerSecuritySettings(SQLModel, table=True):
    ...
    newcomer_member_role_id: Optional[int] = Field(default=None, sa_column=Column(BigInteger, nullable=True))
    ...
    newcomer_block_bot_commands: bool = Field(default=True, nullable=False)
    newcomer_block_attachments: bool = Field(default=True, nullable=False)
    newcomer_block_embeds: bool = Field(default=True, nullable=False)
    newcomer_block_streaming: bool = Field(default=True, nullable=False)
    newcomer_block_threads: bool = Field(default=True, nullable=False)
...
class ServerMonitoringSettings(SQLModel, table=True):
    ...
    notification_cooldown_minutes: int = Field(default=5, nullable=False)
...
class MonitoredUser(SQLModel, table=True):
    ...
    last_notification_at: Optional[datetime] = Field(default=None, nullable=True)
    is_active: bool = Field(default=True, nullable=False, index=True)
    created_at: datetime = Field(default_factory=utcnow_utc_tz, nullable=False)
    updated_at: datetime = Field(default_factory=utcnow_utc_tz, nullable=False)
